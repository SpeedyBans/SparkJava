...
public class LeftJoinExampleWithOptional {
	public static void main(String[] args) {
		...
		JavaPairRDD joinedRDD = visitsRDD.leftOuterJoin(usersRDD);//The RDD structure will be <Integer, Tuple2<Integer,Optional<String>>
