...
public class ReadHdfsFileAsDataset
{
    public static void main(String[] s)
    {
         ...
         *-----------------------------------------------------------------------------------------------------------------------
         *  */
        Dataset<Row> DS = Spark.read().option("header",true).option("delimiter",",").option("inferSchema",true).csv("hdfs://localhost:9000/data/input/avengers.csv");
